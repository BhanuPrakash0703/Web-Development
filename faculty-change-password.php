...
$username=$_SESSION['alogin'];
    $sql ="SELECT Password FROM tblfaculty WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblfaculty set Password=:newpassword where UserName=:username";
                    ...
                    <div class="main-page"  style="background-color: #E5FFA9;">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #FFBCBC;">
                                <div class="col-md-6">
                                    <h2 class="title">Faculty Change Password</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div" style="background-color: #E5FFA9;">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Faculty change password</li>
            						</ul>
                                </div>
