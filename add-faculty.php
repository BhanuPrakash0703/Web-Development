...
$status=1;
$sql="INSERT INTO  tblfaculty(FacultyName,RollId,FacultyEmail,Gender,ClassId,DOB,Status,UserName,Password) VALUES(:facultyname,:rollid,:facultyemail,:gender,:classid,:dob,:status,:uname,:pass)";
...
<html lang="en">
    <head>
        ...
        <title>SRMS Admin | Faculty Admission< </title>
