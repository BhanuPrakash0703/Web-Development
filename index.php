...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="faculty-login.php">Faculty</a></li>
        ...
        <header class="py-5 bg-image-full" style="background-image: url('images/bgi.jpg')">
