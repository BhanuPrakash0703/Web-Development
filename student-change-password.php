...
$username=$_SESSION['alogin'];
    $sql ="SELECT Password FROM tblstudents WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblstudents set Password=:newpassword where UserName=:username";
