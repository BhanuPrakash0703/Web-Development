...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblfaculty set FacultyName=:facultyname,RollId=:rollid,FacultyEmail=:facultyemail,Gender=:gender,DOB=:dob,Status=:status where FacultyId=:stid ";
...
<html lang="en">
    <head>
        ...
        <title>SRMS Admin | Edit Faculty</title>
                    ...
                    <div class="main-page" style="background-color: #E5FFA9;">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #FFBCBC;">
                                <div class="col-md-6">
                                    <h2 class="title">Faculty Admission</h2>
                            ...
                            <div class="row breadcrumb-div" style="background-color: #E5FFA9;">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Faculty Admission</li>
                                    </ul>
                                </div>
...
$sql = "SELECT tblfaculty.FacultyName,tblfaculty.RollId,tblfaculty.RegDate,tblfaculty.FacultyId,tblfaculty.Status,tblfaculty.FacultyEmail,tblfaculty.Gender,tblfaculty.DOB,tblclasses.ClassName,tblclasses.Section from tblfaculty join tblclasses on tblclasses.id=tblfaculty.ClassId where tblfaculty.FacultyId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" value="<?php echo htmlentities($result->FacultyName)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="email" name="emailid" class="form-control" id="email" value="<?php echo htmlentities($result->FacultyEmail)?>" required="required" autocomplete="off">
</div>
</div>
