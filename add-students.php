...
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status,UserName,Password) VALUES(:studentname,:rollid,:studentemail,:gender,:classid,:dob,:status,:uname,:pass)";
