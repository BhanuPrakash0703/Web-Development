                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblfaculty.FacultyName,tblfaculty.RollId,tblfaculty.RegDate,tblfaculty.FacultyId,tblfaculty.Status,tblclasses.ClassName,tblclasses.Section from tblfaculty join tblclasses on tblclasses.id=tblfaculty.ClassId";
...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="edit-faculty.php?stid=<?php echo htmlentities($result->FacultyId);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
